...
class VaccinationsControllerTest < ActionController::TestCase
  ...
  test "should create vaccination" do
    assert_difference('Vaccination.count') do
      post :create, vaccination: { date: @vaccination.date, description: @vaccination.description, title: @vaccination.title, type: @vaccination.type }
    end
  ...
  test "should update vaccination" do
    put :update, id: @vaccination, vaccination: { date: @vaccination.date, description: @vaccination.description, title: @vaccination.title, type: @vaccination.type }
    assert_redirected_to vaccination_path(assigns(:vaccination))
  end
